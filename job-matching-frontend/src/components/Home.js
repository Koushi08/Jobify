...
import projectImage from '/Users/koushismac/SmartHireSolutions/job-matching-frontend/src/components/images/project_image.png'; // Make sure this path is correct
  ...
  return (
    <div className="homepage">
      ...
      <div className="photo-stack">
        <img src={projectImage} alt="Job Matching" />
